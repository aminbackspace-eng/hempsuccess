...
<div class="min-h-screen bg-[#F5F3EE] pt-20">
    ...
    <!-- Detailed Technical SEO Details -->
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div class="space-y-6">
                    <!-- URL Structure -->
                    <div
                        class="bg-[#F5F3EE] p-8 rounded-2xl shadow-sm border border-gray-100 flex gap-6 items-start transition-all hover:shadow-md">
                ...
                <div class="space-y-8">
                    <div class="rounded-2xl overflow-hidden shadow-2xl border border-gray-200 bg-white">
                        <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop"
                            alt="Search Console Dashboard" class="w-full h-auto opacity-90">
                    </div>
                    <div class="px-2">
    ...
    <!-- Original Technical SEO Details -->
